...
buildscript {
    ...
    dependencies {
        classpath "com.infinum.collar:collar-plugin:2.0.0"
    }
}
```
**KotlinDSL**
...
**Groovy**
```gradle
debugImplementation "com.infinum.collar:collar-ui:2.0.0"
releaseImplementation "com.infinum.collar:collar-ui-no-op:2.0.0"
```
**KotlinDSL**
```kotlin
debugImplementation("com.infinum.collar:collar-ui:2.0.0")
